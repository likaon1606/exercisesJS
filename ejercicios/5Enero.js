let userName = null; //se pueden crear variables sin asignarles un valor de inicio
console.log(userName);

/*let contador = 10;
console.log(contador);
contador += 5; //+= es para adición 10+5, -=, /=,
console.log(contador);
contador -= 3;
console.log(contador);
contador *= 2;
...
contador /= 6;
console.log(contador);
contador %= 10;//para los residuos de divisiones
console.log(contador);*/
...
newNumber += number1;// se está reciclando la variable newNumber y sumando al mismo tiempo
console.log(newNumber);
console.log(typeof newNumber);//typeof sirve para saber el tipo de datos que esta en la variable, también se puede usar "console.log(typeof (newNumber))"
...
//IMPORTANTE: en igualdad simple existe una coersión de datos y en la igualdad estricta no la hay